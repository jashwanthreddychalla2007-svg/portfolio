        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus Area</h4>
              <p>
                Building intelligent computer vision systems, automatic number plate recognition (ANPR), traffic anomaly detection, and database-backed desktop software.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">AI / Vision</div>
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>EMBEDDED & WEB SYSTEMS</h3>
              <h4>Focus Area</h4>
              <p>
                Creating smart IoT automation systems integrating environmental sensors, GSM communications, motor control, and responsive web user interfaces.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">GSM</div>
